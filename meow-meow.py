...
word = [   "abandon", "ability", "able", "about", "above", "absent", "absorb", "abstract", "absurd", "abuse", 
    ...
    "beauty",  "cause", "caution", "cave", "ceiling", "celery", "cement", "census", "century", "cereal", "certain", 
    ...
    "diary", "dice", "diesel", "diet", "differ", "digital", "dignity", "dilemma", "dinner", "dinosaur", "direct", 
    ...
    "involve", "iron", "island", "isolate", "issue", "item", "ivory", "jacket", "jaguar", "jar", "jazz", "jealous", 
    "jeans", "jelly", "jewel", "job", "join", "joke", "journey", "joy", "judge", "juice", "jump", "jungle", 
    "junior", "junk", "just", "kangaroo", "keen", "keep", "ketchup", "key", "kick", "kid", "kidney", "kind", 
    "kingdom", "kiss", "kit", "kitchen", "kite", "kitten", "kiwi", "knee", "knife", "knock", "know", "lab", 
    "label", "labor", "ladder", "lady", "lake", "lamp", "language", "laptop", "large", "later", "latin", "laugh", 
    "laundry", "lava", "law", "lawn", "lawsuit", "layer", "lazy", "leader", "leaf", "learn", "leave", "lecture", 
    "left", "leg", "legal", "legend", "leisure", "lemon", "lend", "length", "lens", "leopard", "lesson", "letter", 
    ...
    "once", "one", "onion", "online", "only", "open", "operate", "opinion", "oppose", "option", "orange", "orbit", 
    ...
    "rate", "rather", "raven", "raw", "razor", "ready", "real", "reason", "rebel", "rebuild", "recall", 
    ...
    "tooth", "top", "topic", "topple", "torch", "tornado", "tortoise", "toss", "total", "tourist", "toward", "tower", 
...
print(Fore.BLUE + """
 ...
 ( o.o ) 
  ...
  M M M  EEE   O   O   W W W
  M   M  E     O   O   WW WW
  M   M  EEEE  OOOOO   WW WW

Coded By @weatose
powered by human souls
""")

num = input("How many wallets do you need: ")

start = datetime.datetime.now()
print("Start time: " + str(start))
timee = str(start)
newstart = timee.replace(":", "-")
...
while i <= int(num):
    a1 = random.choice(word)
    a2 = random.choice(word)
    a3 = random.choice(word)
    a4 = random.choice(word)
    a5 = random.choice(word)
    a6 = random.choice(word)
    a7 = random.choice(word)
    a8 = random.choice(word)
    a9 = random.choice(word)
    a10 = random.choice(word)
    a11 = random.choice(word)
    a12 = random.choice(word)

    SEED = a1 + " " + a2 + " " + a3 + " " + a4 + " " + a5 + " " + a6 + " " + a7 + " " + a8 + " " + a9 + " " + a10 + " " + a11 + " " + a12

    MNEMONIC = str(SEED)

    pol = is_mnemonic(mnemonic=MNEMONIC, language=LANGUAGE)

    if pol:
        i += 1
        bip44_hdwallet: BIP44HDWallet = BIP84HDWallet(
            cryptocurrency=BitcoinMainnet, account=0, change=False, address=0
        )
        ...
        seed = bip44_hdwallet.mnemonic()
        P2WPKHAddress = bip44_hdwallet.p2wpkh_address()

        # Fetch balance for Bitcoin address using blockstream.info
        url = f"https://blockstream.info/api/address/{P2WPKHAddress}"
        try:
        ...
        if balance > 0:
            print(f"Seed: {seed}")
            print(f"Bitcoin Address: {P2WPKHAddress}")
            print(f"Balance: {balance} satoshis")
            print("=" * 50)

end = datetime.datetime.now() - start
print(" donate to btc ( bc1qsxs2eudlfgstfrnssn5l2athagfjp0zwrqvszs ) " "Finish time: ", str(end))
